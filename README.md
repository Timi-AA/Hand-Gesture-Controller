...
|---|---|---|
| ✋ Open Palm | Play / Pause | Fires once |
| ✊ Closed Fist | Mute / Unmute | Fires once |
| ✌️ Peace Sign | Volume Up | Repeats while held |
| 👍 Thumbs Up | Volume Down | Repeats while held |
| ☝️ One Finger Up | Next Track | Fires once |
